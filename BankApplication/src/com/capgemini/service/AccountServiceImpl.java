...
public class AccountServiceImpl implements AccountService {
	...
	@Override
	public int depositAmount(int accountNumber, int amount) throws InvalidAccountNumberException , NumberFormatException{
		if(accountNumber>999 || accountNumber<100)
			throw new InvalidAccountNumberException();
		if(amount<0) throw new java.lang.NumberFormatException();
		if(accountRepo.deposit(accountNumber, amount) ) return amount;
		return 0;
	}
