...
public class AccountTest {
	...
	public void whenInvalidAccountNumber() throws InvalidAccountNumberException{
		accountService.depositAmount(1233, 6758);
	}
	
	@Test(expected=java.lang.NumberFormatException.class)
	public void whenInvalidAmount() throws InvalidAccountNumberException,NumberFormatException{
		accountService.depositAmount(101,-23);
	}
}
